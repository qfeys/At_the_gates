...
impl Camera {
    ...
    pub fn mat(&self) -> Matrix4<f32> {
        let zoom_m = Matrix4::from_translation(Vector3 {
            x: 0.0,
            y: 0.0,
            z: -self.zoom,
        });
        ...
        let tr_m = Matrix4::from_translation(self.pos.v32());
    ...
    pub fn move_in_direction(&mut self, direction: Rad<f32>, speed: f32) {
        ...
        self.pos.v.x -= (dy * speed) as f64;
        self.pos.v.y -= (dx * speed) as f64;
        self.clamp_pos();
    }
